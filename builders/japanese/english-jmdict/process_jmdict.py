...
# JMdict_e is the english-jmdict dictionary with only the english translations
#english-jmdict = download.download_if_modified('ftp://ftp.monash.edu.au/pub/nihongo/JMdict_e.gz')
...
def process_jmdict_entry(xml_entry):
    ...
    # Add tags concerning word frequency
